...
const JOURNEY = [
  ...
  { num: '02', icon: '📖', label: 'Story',    desc: 'Sophie\'s fun fair' },
  { num: '03', icon: '🧪', label: 'Simulate', desc: '4 interactive labs' },
  { num: '04', icon: '🎮', label: 'Practice', desc: '10 districts & bosses' },
  ...
  return (
    <div className="intro-wrap">
      ...
      <div className="intro-top-badge">
        ✨ Curriculum · Reading Pictographs Grade 3
      </div>

      {/* Main Title */}
      <h1 className="intro-title">
        <span className="text-orange">Reading</span> <span className="text-white">Pictographs</span>
      </h1>
      <h2 className="intro-subtitle">PictoQuest · Master Picture Graphs & Data</h2>

      {/* Mascot Row */}
      <div className="intro-mascot-row">
        <div className="intro-mascot-circle">🦉</div>
        <div className="intro-speech-bubble">
          Hi! I'm Tally. Ready to<br />explore picture graphs and crack keys? 🍎📊
        </div>
      </div>

      {/* Description */}
      <p className="intro-desc">
        Learn how to read the <span className="text-yellow">Key</span>, multiply picture symbols, compare categories, and solve fun fair survey puzzles!
      </p>
